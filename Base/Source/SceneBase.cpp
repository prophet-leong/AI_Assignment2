...
void SceneBase::RenderText(Mesh* mesh, std::string text, Color color)
{
	...
	for(unsigned i = 0; i < text.length(); ++i)
	{
		...
		characterSpacing.SetToTranslation(i * 0.6f, 0, 0); //0.6f is the spacing of each character, you may change this value
...
void SceneBase::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y)
{
	...
	{
		Mtx44 characterSpacing;
		characterSpacing.SetToTranslation(i * 0.6f + 0.1f, 0.5f, 0); //1.0f is the spacing of each character, you may change this value
		Mtx44 MVP = projectionStack.Top() * viewStack.Top() * modelStack.Top() * characterSpacing;
		glUniformMatrix4fv(m_parameters[U_MVP], 1, GL_FALSE, &MVP.a[0]);
